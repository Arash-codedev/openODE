...
/* Path: ./auto-coded/systems/arneodosys/solver.cpp */
...
bool ArneodoSys_solver::less_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		//return t1 < t2;
...
bool ArneodoSys_solver::less_eq_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		return t1-t2 <= epsilon;
	else
...
void ArneodoSys_solver::plant_do_step(
		ArneodoSys_manager &usersystem,
		position &plant_x,
		double &t,
		double &dt)
{
...
void ArneodoSys_solver::plant_do_step2(
		ArneodoSys_manager &usersystem,
		const position &x_in,
...
double ArneodoSys_solver::plant_error(const position &plant_x_old,const position &plant_dxdt_old,position &plant_x_err,double dt) const
{
...
ArneodoSys_solver::ArneodoSys_solver(ArneodoSys_manager &usersystem):
...
std::size_t ArneodoSys_solver::integrate(
