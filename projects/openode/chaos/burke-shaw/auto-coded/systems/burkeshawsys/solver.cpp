...
/* Path: ./auto-coded/systems/burkeshawsys/solver.cpp */
...
bool BurkeShawSys_solver::less_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		//return t1 < t2;
...
bool BurkeShawSys_solver::less_eq_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		return t1-t2 <= epsilon;
	else
...
void BurkeShawSys_solver::plant_do_step(
...
void BurkeShawSys_solver::plant_do_step2(
		BurkeShawSys_manager &usersystem,
		const position &x_in,
...
double BurkeShawSys_solver::plant_error(const position &plant_x_old,const position &plant_dxdt_old,position &plant_x_err,double dt) const
{
...
BurkeShawSys_solver::BurkeShawSys_solver(BurkeShawSys_manager &usersystem):
...
std::size_t BurkeShawSys_solver::integrate(
