...
/* Path: ./auto-coded/systems/chensys/solver.cpp  */
...
bool ChenSys_solver::less_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		//return t1 < t2;
...
bool ChenSys_solver::less_eq_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		return t1-t2 <= epsilon;
	else
...
void ChenSys_solver::plant_do_step(
...
void ChenSys_solver::plant_do_step2(
		ChenSys_manager &usersystem,
		const position &x_in,
...
double ChenSys_solver::plant_error(const position &plant_x_old,const position &plant_dxdt_old,position &plant_x_err,double dt) const
{
...
ChenSys_solver::ChenSys_solver(ChenSys_manager &usersystem):
...
std::size_t ChenSys_solver::integrate(
