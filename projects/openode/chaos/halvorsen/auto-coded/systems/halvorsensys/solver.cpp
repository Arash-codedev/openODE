...
/* Path: ./auto-coded/systems/halvorsensys/solver.cpp */
...
bool HalvorsenSys_solver::less_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		//return t1 < t2;
...
bool HalvorsenSys_solver::less_eq_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		return t1-t2 <= epsilon;
	else
...
void HalvorsenSys_solver::plant_do_step(
...
void HalvorsenSys_solver::plant_do_step2(
		HalvorsenSys_manager &usersystem,
		const position &x_in,
...
double HalvorsenSys_solver::plant_error(const position &plant_x_old,const position &plant_dxdt_old,position &plant_x_err,double dt) const
{
...
HalvorsenSys_solver::HalvorsenSys_solver(HalvorsenSys_manager &usersystem):
...
std::size_t HalvorsenSys_solver::integrate(
