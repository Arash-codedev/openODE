...
/* Path: ./auto-coded/systems/symmetric-flow-sys/solver.cpp */
...
bool SymmetricFlowSys_solver::less_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		//return t1 < t2;
...
bool SymmetricFlowSys_solver::less_eq_with_sign(double t1,double t2,double dt)
{
	if(dt>0.0)
		return t1-t2 <= epsilon;
	else
...
void SymmetricFlowSys_solver::plant_do_step(
		SymmetricFlowSys_manager &usersystem,
		position &plant_x,
		double &t,
		double &dt)
{
...
void SymmetricFlowSys_solver::plant_do_step2(
		SymmetricFlowSys_manager &usersystem,
		const position &x_in,
...
double SymmetricFlowSys_solver::plant_error(const position &plant_x_old,const position &plant_dxdt_old,position &plant_x_err,double dt) const
{
...
SymmetricFlowSys_solver::SymmetricFlowSys_solver(SymmetricFlowSys_manager &usersystem):
...
std::size_t SymmetricFlowSys_solver::integrate(
